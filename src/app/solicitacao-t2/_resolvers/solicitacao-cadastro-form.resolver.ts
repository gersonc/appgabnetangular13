...
import {CadastroFormulario, CadastroFormularioInterface} from "../../cadastro/_models";
import {CadastroService} from "../../cadastro/_services";

@Injectable({
  providedIn: 'root'
})
export class SolicitacaoCadastroFormResolver implements Resolve<CadastroFormularioInterface> {
