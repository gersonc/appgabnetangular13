...
export class ProposicaoDatatableComponent implements OnInit, OnDestroy {
  ...
  montaMenuContexto() {
    ...
    if (this.aut.usuario_principal_sn || this.aut.usuario_responsavel_sn || this.aut.proposicao_alterar) {
    ...
    if (this.aut.usuario_principal_sn || this.aut.usuario_responsavel_sn || this.aut.proposicao_apagar) {
      this.contextoMenu.push(
        {
