/* tslint:disable */
import {Component, OnDestroy, OnInit, ElementRef, ViewChild, Input, Output, EventEmitter} from '@angular/core';
import {
  ProcessoCadastroInterface,
  ProcessoDetalheInterface,
  ProcessoHistoricoInterface, ProcessoListagemInterface,
...
export class ProcessoDetalheComponent implements OnInit, OnDestroy {
  @Output() hideDetalhe = new EventEmitter<boolean>();
  @Input() proDetalhe: ProcessoDetalheInterface = null;
  ...
  ngOnInit() {
    ...
    this.processo = this.proDetalhe.processo;
    this.processo_titulo = this.proDetalhe.processo_titulo;
    this.cadastro = this.proDetalhe.cadastro;
    this.cadastro_titulo = this.proDetalhe.cadastro_titulo;
    this.oficios = this.proDetalhe.oficios;
    this.oficio_titulo = this.proDetalhe.oficio_titulo;
    this.oficios_num = this.proDetalhe.oficios_num;
