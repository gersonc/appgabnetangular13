...
export interface EmendaDropdownMenuI {
  ...
  dd_emenda_data_solicitacao1: SelectItem[];
  dd_emenda_data_solicitacao2: SelectItem[];
  dd_emenda_data_empenho1: SelectItem[];
  dd_emenda_data_empenho2: SelectItem[];
  dd_emenda_data_pagamento1: SelectItem[];
  dd_emenda_data_pagamento2: SelectItem[];
