...
import {OficioDetalheInterface, OficioInterface, OficioPaginacaoInterface} from "../_models/oficio";
...
export class OficioService2 {
  ...
  postOficioBusca(dados: OficioBuscaI): Observable<OficioPaginacaoInterface> {
