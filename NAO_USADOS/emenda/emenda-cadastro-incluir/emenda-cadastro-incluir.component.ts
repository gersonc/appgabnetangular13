...
@Component({
  selector: 'app-emenda-cadastro-incluir',
  templateUrl: './emenda-cadastro-incluir.component.html',
  styleUrls: ['./emenda-cadastro-incluir.component.css']
})
export class EmendaCadastroIncluirComponent implements OnInit, OnDestroy {
  ...
  criaCadastro() {
    ...
    console.log('cadastro2', this.cs.cadastro);
  }
  ...
  voltarModulo() {
    this.cr.mostraCarregador();
    this.router.navigate(['/emenda/incluir/cadastro/cadastro',
